...
image_directory = r'/mnt/c/Users/swmar/CMS/Subject/ComputerScience/code/misc_code/CMS_AstroPI/SamStuff/example-stuff/images'
# print(os.getcwd())
...
# Print all speeds
n=3
all_speeds_filter_one = [num for num in all_speeds]
