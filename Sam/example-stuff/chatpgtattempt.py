...
def calculate_features(image_1_cv, image_2_cv, feature_number):
    ...
    # Convert descriptors to UMat
    descriptors_1 = cv2.UMat(descriptors_1)
    descriptors_2 = cv2.UMat(descriptors_2)
...
def main():
    ...
    for i in range(len(image_files) - 1):
        ...
        keypoints_1, descriptors_1 = calculate_features(image_1_cv, None, 1000)
        keypoints_2, descriptors_2 = calculate_features(image_2_cv, None, 1000)
        ...
        # Replace this with your geospatial calculations using coordinates_1 and coordinates_2
